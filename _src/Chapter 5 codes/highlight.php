...
//set highlighting html tags
$hl->setSimplePrefix('<b>');
$hl->setSimplePostfix('</b>');
// highlight upto 2 snippets
$hl->setSnippets(2);
// set the size in characters of fragments to consider for highlighting
// 0 uses the whole field value without any fragmentation
$hl->setFragSize(0);
// merge contiguous fragments into a single fragment
